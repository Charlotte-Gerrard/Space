...
LJMU::LJMUPlayerControls::LJMUPlayerControls(bool pprimary)
{
	...
	this->_actions.insert(std::make_pair(sf::Keyboard::Key::Num2, LJMUPlayerActions::FIRE_MULTI_BULLET));
	this->_actions.insert(std::make_pair(sf::Keyboard::Key::Num1, LJMUPlayerActions::SINGLE_BULLET));
	this->_actions.insert(std::make_pair(sf::Keyboard::Key::Num3, LJMUPlayerActions::GRANADE));
	this->_actions.insert(std::make_pair(sf::Keyboard::Key::Num4, LJMUPlayerActions::WAVE_BULLET));
	this->_actions.insert(std::make_pair(sf::Keyboard::Key::Escape, LJMUPlayerActions::PAUSE));
	...
	this->_flags.insert(std::make_pair(LJMUPlayerActions::FIRE_MULTI_BULLET, false));
	this->_flags.insert(std::make_pair(LJMUPlayerActions::WAVE_BULLET, false));
	this->_flags.insert(std::make_pair(LJMUPlayerActions::PAUSE, false));
}
