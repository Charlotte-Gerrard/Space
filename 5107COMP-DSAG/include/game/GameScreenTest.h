#ifndef __GAME_SCREEN_TEST_H_
#define __GAME_SCREEN_TEST_H_
...
namespace LJMU
{
	...
	///////////////////////////////
	class GameScreenTest : public sf::ILJMUScreenBase
	{
		//-----------CONSTRUCTOR/DESTRUCTOR----------------------------------
	public:
		GameScreenTest();	//Default Constructor
		~GameScreenTest();	//Default Destructor
	...
	public:
		...
		void setOptions(int diff, int control);
	...
	sf::LJMUResourceHelper<sf::Texture,std::string>   _res_level;		//Resource Manager for Level BG
		...
		std::vector<LJMU::GameObjectBasic>      _weapon_sprites;		//Menu Sprites
		std::vector<LJMU::GameObjectBasic>      _menu_sprites;		//Menu Sprites
		std::vector<LJMU::GameHUDElemBasic>		_menu_elems;		//Menu Collection

		

		std::vector<std::string>                _option_choices;    //Example Data for a Menu
		int										_selected_index;
