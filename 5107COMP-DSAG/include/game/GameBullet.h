...
namespace LJMU
{
	...
	public:
		...
		//LJMUBullet();
		LJMUBullet(sf::Sprite psprite, sf::Vector2f pdir, sf::Vector2f pspawnpos, sf::Time pspawntime, BulletMotion pmotion = BulletMotion::LINEAR);
		~LJMUBullet();
	public:
		//----------PUBLIC METHODS------------------------------------------------------
